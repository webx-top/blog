...
if(lf)
label=lf(label,s);fragments.push('<td class="legendColorBox"><div style="border:1px solid '+options.legend.labelBoxBorderColor+';padding:1px"><div style="width:12px;height:0;border:5px solid '+s.color+';overflow:hidden"></div></div></td>'+'<td class="legendLabel">'+label+'</td>');}
if(rowStarted)
...
/* <from: Flot/jquery.flot.resize.js> */
...
{if(!target)return;ctx=newCtx;setupPie();var slices=plot.getData();var attempts=0;var redraw=true;while(redraw&&attempts<redrawAttempts)
